				...
				<>
						...
						>
							...
							<Flex>
								...
								<Text
									...
									fontSize={15}
								>
									{networkingSettings.downloadKbps == 0
										? i18n(lang, "unlimited")
										: networkingSettings.downloadKbps + " Kbps"}
								</Text>
							</Flex>
							<Flex>
								<Link
					...
					>
						...
						>
							...
							/>
							<ModalHeader color={colors(platform, darkMode, "textPrimary")}>{i18n(lang, "networkThrottling")}</ModalHeader>
							<ModalBody>
								<Flex
									flexDirection="row"
									justifyContent="space-between"
