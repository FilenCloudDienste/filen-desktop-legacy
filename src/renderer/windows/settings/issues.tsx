			...
			>
				...
				>
					<ModalCloseButton
						...
						_hover={{ backgroundColor: colors(platform, darkMode, "backgroundSecondary") }}
					/>
					<ModalHeader color={colors(platform, darkMode, "textPrimary")}>{i18n(lang, "help")}</ModalHeader>
					<ModalBody>
							...
							<>
								...
								>
									{(() => {
										...
										if (
											syncIssueHelp.err.message.indexOf("EBUSY") !== -1 ||
											syncIssueHelp.err.message.indexOf("ELOCKED")
										) {
											return i18n(lang, "possibleSolutionEBUSY")
										}

										if (
											syncIssueHelp.err.message.indexOf("EMFILE") !== -1 ||
