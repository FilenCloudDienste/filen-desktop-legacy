...
const applyDoneTasksToSavedState = async ({ doneTasks, localTreeNow, remoteTreeNow }: { doneTasks: any, localTreeNow: any, remoteTreeNow: any }): Promise<{ localTreeNowApplied: any, remoteTreeNowApplied: any }> => {
