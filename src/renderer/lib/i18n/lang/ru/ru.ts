const ru: {
    ...
    updateWindowInfo3: "Клиент выйдет и запустит поток обновления в фоновом режиме. Он перезапустится после завершения работы. Пожалуйста, не прерывайте этот процесс."
}
