const ru: {
	...
	possibleSolutionENAMETOOLONG: "Слишком длинное имя файла или путь к нему. Пожалуйста, уменьшите длину до значения, поддерживаемого вашей операционной системой.",
	issue: "Проблема",
	path: "Путь"
}
