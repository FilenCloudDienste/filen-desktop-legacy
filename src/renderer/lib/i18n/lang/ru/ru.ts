const ru: {
    ...
    cancel: "Отменить",
    cannotCreateSyncLocationLoop2: "Выбранный вами локальный путь уже является настроенным местом синхронизации. Это может привести к бесконечным циклам синхронизации"
}
