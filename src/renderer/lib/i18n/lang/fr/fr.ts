const fr: {
    ...
    updateWindowInfo3: "Le client de synchro va se fermer et redémarrer pour mettre à jour le flux en arrière-plan. Veuillez ne pas interrpompre le process, il va redémarrer de lui-même.",
    pleaseLogin: "Se connecter",
    traySyncIssues: "__NUM__ erreurs de synchro",
    traySyncing: "Synchro de __NUM__ objets",
    everythingSynced: "Tout est à jour",
    trayWarnings: "__NUM__ alertes",
    trayNoSyncSetup: "Pas d'emplacement de synchro encore configuré",
    trayNoSyncRemoteSetup: "Pas d'emplacement distant de synchro encore configuré",
    ...
    openLocalTrash: "Ouvrir la corbeille locale",
     help: "Aide",
    possibleSolution: "Solution possible",
    possibleSolutionEPERM: "Veuillez vous assurer que le client de synchro a toutes les permissions nécessaires pour lire et écrire dans le chemin ci-dessus.",
    possibleSolutionENOENT: "Veuillez vous assurer que le chemin ci-dessus existe.",
    possibleSolutionEBUSY: "Le client de synchro n'arrive pas à accéder au chemin ci-dessus. Veuillez vérifier que d'autres programmes ne sont pas en train de l'utiliser et de bloquer son accès.",
    possibleSolutionEMFILE: "Il n'y a pas assez d'espace libre ou il manque des identifiants de fichiers.",
    issue: "Problème",
    path: "Chemin"
}
