const uk: {
	...
	possibleSolutionENAMETOOLONG: "Занадто довге ім'я файлу або шлях до нього. Будь ласка, зменшіть довжину до значення, яке підтримується вашою операційною системою.",
	issue: "Проблема",
	path: "Шлях"
}
