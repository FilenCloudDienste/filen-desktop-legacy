const uk: {
    ...
    cancel: "Скасувати",
    cannotCreateSyncLocationLoop2: "Місце на хмарі, яке ви вибрали, вже є налаштованим місцем синхронізації. Це може призвести до нескінченних циклів синхронізації",
    titlebarUpdateAvailable: "Доступне оновлення",
    updateWindowInfo: "Нова версія завантажена та готова до встановлення. Будь ласка, встановіть її якомога швидше, щоб скористатися перевагами виправлень помилок і нових функцій.",
    ...
    updateWindowInfo3: "Клієнт завершить роботу і запустить потік оновлень у фоновому режимі. Він перезапуститься, коли завершить роботу. Будь ласка, не переривайте цей процес."
}
