const tr: {
	...
	cannotCreateSyncLocationLoop:
		"Seçtiğiniz yerel yol zaten yapılandırılmış bir eşitleme konumu. Bu, sonsuz eşitleme döngülerine yol açabilir",
	...
	clearSyncIssuesInfo:
		"Gösterilen sorunları temizlerken, istemci yeniden eşitlemeyi deneyecek. Lütfen bunları temizlemeden önce tüm sorunları çözdüğünüzden emin olun.",
	clear: "temiz",
	...
	maxStorageReached:
		"Hesabınızın maksimum depolama hacmine ulaştınız. Senkronizasyona devam edebilmek için yükseltme yapmanızı öneririz.",
	...
	cancel: "İptal",
	canCreateSyncLocationLoop2:
		"Seçtiğiniz uzak yol zaten yapılandırılmış bir eşitleme konumu. Bu, sonsuz eşitleme döngülerine yol açabilir",
	titlebarUpdateAvailable: "Güncelleme mevcut",
	updateWindowInfo:
		"Yeni bir sürüm indirildi ve kurulmaya hazır. Hata düzeltmelerinden ve yeni özelliklerden yararlanmak için lütfen mümkün olan en kısa sürede kurun.",
